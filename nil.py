...
def derivatives_hpc(t, y):
    ...
    H_val = Ha
    K_fac = sqrt_neg_k / (c * a_t * 2.56e-18 + eps)                                                         		  #Dimensionless qty, since numerator is in sec inverse
      
    calD = Ha + eps
    
    d_theta = 0
    d_phi = (1.0 * np.sqrt(-k) / (c * a_t + eps)) * np.cos(theta)
    d_psi_real = 0
    d_psi_imag = 0
    ...
    term_C1   = (0.2 * K_fac * R0_23) + (0.2 * K_fac * R0_32)
    term_C1_I = (0.2 * K_fac * I0_23) + (0.2 * K_fac * I0_32)

    dR0_1 = - (0.6 * H_val * (zetaR * R0_1 - zetaI * I0_1) + term_C1) - tau * R0_1
    dI0_1 = - (0.6 * H_val * (zetaR * I0_1 + zetaI * R0_1) + term_C1_I) - tau * (2.0/3.0) * I0_1

    term_C2   = (-0.2 * K_fac * R0_13) + (-0.2 * K_fac * R0_31)
    term_C2_I = (-0.2 * K_fac * I0_13) + (-0.2 * K_fac * I0_31)

    dR0_2 = - (0.6 * H_val * (zetaR * R0_2 - zetaI * I0_2) + term_C2) - tau * R0_2
    dI0_2 = - (0.6 * H_val * (zetaR * I0_2 + zetaI * R0_2) + term_C2_I) - tau * (2.0/3.0) * I0_2

    term_C3   = (-0.2 * K_fac * R0_12) + (0.2 * K_fac * R0_21)
    term_C3_I = (-0.2 * K_fac * I0_12) + (0.2 * K_fac * I0_21)
    ...
    Kr_diag_trace = 0.444444444 * H_val
    Kr_off_trace  = -0.222222222 * H_val
    Kr_diag_sym   = 0.333333333 * H_val
    Kr_off_sym    = 0.333333333 * H_val
    Ki_common     = 0.333333333 * K_fac 

    kn_11_r, kn_11_i = calc_KN(Kr_diag_trace, Ki_common, R2_11, I2_11)
    kn_22_r, kn_22_i = calc_KN(Kr_off_trace,  0.0,       R2_22, I2_22)
    kn_33_r, kn_33_i = calc_KN(Kr_off_trace,  0.0,       R2_33, I2_33)
    ...
    kn_12_r, kn_12_i = calc_KN(Kr_diag_sym, Ki_common, R2_12, I2_12)
    kn_21_r, kn_21_i = calc_KN(Kr_off_sym,  0.0,       R2_21, I2_21)
    ...
    kn_13_r, kn_13_i = calc_KN(Kr_diag_sym, Ki_common, R2_13, I2_13)
    kn_31_r, kn_31_i = calc_KN(Kr_off_sym,  0.0,       R2_31, I2_31)
    ...
    kn_12_r_21, kn_12_i_21 = calc_KN(Kr_off_sym,  0.0,       R2_12, I2_12)
    kn_21_r_21, kn_21_i_21 = calc_KN(Kr_diag_sym, Ki_common, R2_21, I2_21)
    ...
    kn_11_r_22, kn_11_i_22 = calc_KN(Kr_off_trace,  0.0,       R2_11, I2_11)
    kn_22_r_22, kn_22_i_22 = calc_KN(Kr_diag_trace, Ki_common, R2_22, I2_22)
    kn_33_r_22, kn_33_i_22 = calc_KN(Kr_off_trace,  0.0,       R2_33, I2_33)
    ...
    kn_23_r, kn_23_i = calc_KN(Kr_diag_sym, Ki_common, R2_23, I2_23)
    kn_32_r, kn_32_i = calc_KN(Kr_off_sym,  0.0,       R2_32, I2_32)
    ...
    kn_13_r_31, kn_13_i_31 = calc_KN(Kr_off_sym,  0.0,       R2_13, I2_13)
    kn_31_r_31, kn_31_i_31 = calc_KN(Kr_diag_sym, Ki_common, R2_31, I2_31)
    ...
    kn_23_r_32, kn_23_i_32 = calc_KN(Kr_off_sym,  0.0,       R2_23, I2_23)
    kn_32_r_32, kn_32_i_32 = calc_KN(Kr_diag_sym, Ki_common, R2_32, I2_32)
    ...
    kn_11_r_33, kn_11_i_33 = calc_KN(Kr_off_trace,  0.0,       R2_11, I2_11)
    kn_22_r_33, kn_22_i_33 = calc_KN(Kr_off_trace,  0.0,       R2_22, I2_22)
    kn_33_r_33, kn_33_i_33 = calc_KN(Kr_diag_trace, Ki_common, R2_33, I2_33)
...
def solve_single_pixel(args):
    ...
    for i in range(len(t_eval_pts)):
        ...
        # Full Stokes-V construction from Im(N^0) (CONSISTENCY CHECK IN AMPLITUDE) -----------------------------------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    save_path = os.path.join(output_dir, "Nil.png")
    ...
    plt.title('Evolution of fluctuation amplitudes in Nil', fontsize=14)
    plt.legend()
    plt.grid(True, which="both", ls="--", alpha=0.5)
    
    amp_save_path = os.path.join(output_dir, "nil_ampl.png")
