...
os.makedirs("TEB/Nil", exist_ok=True)

data = np.load("results_maps/map_nil.npz")
...
for t in plt.gcf().axes[1].texts:
    t.set_fontsize(20)
plt.savefig("TEB/Nil/pure_t.png", dpi=150, bbox_inches="tight")
...
for t in plt.gcf().axes[1].texts:
    t.set_fontsize(20)
plt.savefig("TEB/Nil/pure_e(q).png", dpi=150, bbox_inches="tight")
...
for t in plt.gcf().axes[1].texts:
    t.set_fontsize(20)
plt.savefig("TEB/Nil/pure_e(u).png", dpi=150, bbox_inches="tight")
...
for t in plt.gcf().axes[1].texts:
    t.set_fontsize(20)
plt.savefig("TEB/Nil/pure_b(q).png", dpi=150, bbox_inches="tight")
...
for t in plt.gcf().axes[1].texts:
    t.set_fontsize(20)
plt.savefig("TEB/Nil/pure_b(u).png", dpi=150, bbox_inches="tight")
