...
def derivatives_hpc(t, y):
    ...
    # -------------------------------------------------------------------------------------------------------------------
    sum_R = R0_11 + R0_22 + R0_33
    sum_I = I0_11 + I0_22 + I0_33
    ...
    D_Re = R00 - c_fac * sum_R
    D_Im = I00 - c_fac * sum_I

    inv_D_sq = 1.0 / (D_Re**2 + D_Im**2 + EPS)
    C_Re = (R00 * D_Re + I00 * D_Im) * inv_D_sq
    C_Im = (I00 * D_Re - R00 * D_Im) * inv_D_sq
    # -------------------------------------------------------------------------------------------------------------------
    
    dR00 = S_Re * C_Re - S_Im * C_Im
    dI00 = S_Re * C_Im + S_Im * C_Re
    
    zetaR = -(R00 * dR00 + I00 * dI00)/(calD * (R00**2 + I00**2 + eps))
    zetaI = -(R00 * dI00 - dR00 * I00)/(calD * (R00**2 + I00**2 + eps))
    
    dR0_1 = -0.6*Ha*(zetaR*R0_1 - zetaI*I0_1) - tau*(R0_1)
    dR0_2 = -0.6*Ha*(zetaR*R0_2 - zetaI*I0_2) - tau*(R0_2)
    dR0_3 = -0.6*Ha*(zetaR*R0_3 - zetaI*I0_3) - tau*(R0_3)

    dI0_1 = -0.6*Ha*(zetaR*I0_1 + zetaI*R0_1) - tau*(2/3)*I0_1
    dI0_2 = -0.6*Ha*(zetaR*I0_2 + zetaI*R0_2) - tau*(2/3)*I0_2
    dI0_3 = -0.6*Ha*(zetaR*I0_3 + zetaI*R0_3) - tau*(2/3)*I0_3

    dR0_11 = Ha*(zetaR*R0_11 - zetaI*I0_11) - tau*((9/10)*R0_11 + (3/10)*R2_11)
    dR0_12 = Ha*(zetaR*R0_12 - zetaI*I0_12) - tau*((9/10)*R0_12 + (3/10)*R2_12)
    dR0_13 = Ha*(zetaR*R0_13 - zetaI*I0_13) - tau*((9/10)*R0_13 + (3/10)*R2_13)
    dR0_21 = Ha*(zetaR*R0_21 - zetaI*I0_21) - tau*((9/10)*R0_21 + (3/10)*R2_21)
    dR0_22 = Ha*(zetaR*R0_22 - zetaI*I0_22) - tau*((9/10)*R0_22 + (3/10)*R2_22)
    dR0_23 = Ha*(zetaR*R0_23 - zetaI*I0_23) - tau*((9/10)*R0_23 + (3/10)*R2_23)
    dR0_31 = Ha*(zetaR*R0_31 - zetaI*I0_31) - tau*((9/10)*R0_31 + (3/10)*R2_31)
    dR0_32 = Ha*(zetaR*R0_32 - zetaI*I0_32) - tau*((9/10)*R0_32 + (3/10)*R2_32)
    dR0_33 = Ha*(zetaR*R0_33 - zetaI*I0_33) - tau*((9/10)*R0_33 + (3/10)*R2_33)

    dI0_11 = Ha*(zetaR*I0_11 + zetaI*R0_11) - tau*(I0_11)
    dI0_12 = Ha*(zetaR*I0_12 + zetaI*R0_12) - tau*(I0_12)
    dI0_13 = Ha*(zetaR*I0_13 + zetaI*R0_13) - tau*(I0_13)
    dI0_21 = Ha*(zetaR*I0_21 + zetaI*R0_21) - tau*(I0_21)
    dI0_22 = Ha*(zetaR*I0_22 + zetaI*R0_22) - tau*(I0_22)
    dI0_23 = Ha*(zetaR*I0_23 + zetaI*R0_23) - tau*(I0_23)
    dI0_31 = Ha*(zetaR*I0_31 + zetaI*R0_31) - tau*(I0_31)
    dI0_32 = Ha*(zetaR*I0_32 + zetaI*R0_32) - tau*(I0_32)
    dI0_33 = Ha*(zetaR*I0_33 + zetaI*R0_33) - tau*(I0_33)

    dR2_11 = Ha*(zetaR*R2_11 - zetaI*I2_11) - ((4/9)*Ha*R2_11 + (-2/9)*Ha*R2_22 + (-2/9)*Ha*R2_33) - tau*((1/5)*R0_11 + (2/5)*R2_11)
    dR2_12 = Ha*(zetaR*R2_12 - zetaI*I2_12) - ((1/3)*Ha*R2_12 + (1/3)*Ha*R2_21) - tau*((1/5)*R0_12 + (2/5)*R2_12)
    dR2_13 = Ha*(zetaR*R2_13 - zetaI*I2_13) - ((1/3)*Ha*R2_13 + (1/3)*Ha*R2_31) - tau*((1/5)*R0_13 + (2/5)*R2_13)
    dR2_21 = Ha*(zetaR*R2_21 - zetaI*I2_21) - ((1/3)*Ha*R2_12 + (1/3)*Ha*R2_21) - tau*((1/5)*R0_21 + (2/5)*R2_21)
    dR2_22 = Ha*(zetaR*R2_22 - zetaI*I2_22) - ((-2/9)*Ha*R2_11 + (4/9)*Ha*R2_22 + (-2/9)*Ha*R2_33) - tau*((1/5)*R0_22 + (2/5)*R2_22)
    dR2_23 = Ha*(zetaR*R2_23 - zetaI*I2_23) - ((1/3)*Ha*R2_23 + (1/3)*Ha*R2_32) - tau*((1/5)*R0_23 + (2/5)*R2_23)
    dR2_31 = Ha*(zetaR*R2_31 - zetaI*I2_31) - ((1/3)*Ha*R2_13 + (1/3)*Ha*R2_31) - tau*((1/5)*R0_31 + (2/5)*R2_31)
    dR2_32 = Ha*(zetaR*R2_32 - zetaI*I2_32) - ((1/3)*Ha*R2_23 + (1/3)*Ha*R2_32) - tau*((1/5)*R0_32 + (2/5)*R2_32)
    dR2_33 = Ha*(zetaR*R2_33 - zetaI*I2_33) - ((-2/9)*Ha*R2_11 + (-2/9)*Ha*R2_22 + (4/9)*Ha*R2_33) - tau*((1/5)*R0_33 + (2/5)*R2_33)

    dI2_11 = Ha*(zetaR*I2_11 + zetaI*R2_11) - ((4/9)*Ha*I2_11 + (-2/9)*Ha*I2_22 + (-2/9)*Ha*I2_33) - tau*(I2_11)
    dI2_12 = Ha*(zetaR*I2_12 + zetaI*R2_12) - ((1/3)*Ha*I2_12 + (1/3)*Ha*I2_21) - tau*(I2_12)
    dI2_13 = Ha*(zetaR*I2_13 + zetaI*R2_13) - ((1/3)*Ha*I2_13 + (1/3)*Ha*I2_31) - tau*(I2_13)
    dI2_21 = Ha*(zetaR*I2_21 + zetaI*R2_21) - ((1/3)*Ha*I2_12 + (1/3)*Ha*I2_21) - tau*(I2_21)
    dI2_22 = Ha*(zetaR*I2_22 + zetaI*R2_22) - ((-2/9)*Ha*I2_11 + (4/9)*Ha*I2_22 + (-2/9)*Ha*I2_33) - tau*(I2_22)
    dI2_23 = Ha*(zetaR*I2_23 + zetaI*R2_23) - ((1/3)*Ha*I2_23 + (1/3)*Ha*I2_32) - tau*(I2_23)
    dI2_31 = Ha*(zetaR*I2_31 + zetaI*R2_31) - ((1/3)*Ha*I2_13 + (1/3)*Ha*I2_31) - tau*(I2_31)
    dI2_32 = Ha*(zetaR*I2_32 + zetaI*R2_32) - ((1/3)*Ha*I2_23 + (1/3)*Ha*I2_32) - tau*(I2_32)
    dI2_33 = Ha*(zetaR*I2_33 + zetaI*R2_33) - ((-2/9)*Ha*I2_11 + (-2/9)*Ha*I2_22 + (4/9)*Ha*I2_33) - tau*(I2_33)
...
if __name__ == "__main__":
    ...
    save_path = os.path.join(output_dir, "R3.png")
