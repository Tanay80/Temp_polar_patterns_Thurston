...
os.makedirs("TEB/UH2", exist_ok=True)

data = np.load("results_maps/map_uh2.npz")
...
for t in plt.gcf().axes[1].texts:
    t.set_fontsize(20)
plt.savefig("TEB/UH2/pure_t.png", dpi=150, bbox_inches="tight")
...
for t in plt.gcf().axes[1].texts:
    t.set_fontsize(20)
plt.savefig("TEB/UH2/pure_e(q).png", dpi=150, bbox_inches="tight")
...
for t in plt.gcf().axes[1].texts:
    t.set_fontsize(20)
plt.savefig("TEB/UH2/pure_e(u).png", dpi=150, bbox_inches="tight")
...
for t in plt.gcf().axes[1].texts:
    t.set_fontsize(20)
plt.savefig("TEB/UH2/pure_b(q).png", dpi=150, bbox_inches="tight")
...
for t in plt.gcf().axes[1].texts:
    t.set_fontsize(20)
plt.savefig("TEB/UH2/pure_b(u).png", dpi=150, bbox_inches="tight")
